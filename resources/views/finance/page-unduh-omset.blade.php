...
<body class="max-w-3xl mx-auto p-10 font-sans text-black text-sm">
  ...
  <div class="flex justify-between items-center mb-2">
    <div class="space-y-1">
      <p class="text-lg font-semibold"><span class="inline-block w-20 font-semibold text-lg">Email</span>: Areakerja@gmail.com</p>
      <p class="text-lg font-semibold"><span class="inline-block w-20 font-semibold text-lg">Telepon</span>: 081234567009</p>
    </div>
  ...
  <div class="mt-6 text-sm space-y-1">
    <p class="text-lg font-semibold"><span class="inline-block w-28 text-lg font-semibold"">Jumlah Bulan</span> : 11</p>
    <p class="text-lg font-semibold""><span class="inline-block w-28 text-lg font-semibold"">Total Omset</span> : Rp 33.000.000,00</p>
    <p class="text-lg font-semibold""><span class="inline-block w-28 text-lg font-semibold"">Rata-rata</span> : Rp 3.000.000,00</p>
  </div><br>
