...
<body class="min-h-screen bg-gradient-to-b from-orange-500 to-orange-400 font-sans flex items-center justify-center">
              ...
              <button class="w-10 h-10 flex items-center justify-center border rounded-full hover:bg-gray-100 text-gray-700 font-bold">
               in
                ...
                <form action="#" class="space-y-3">
                    ...
                    <!-- Tombol Daftar -->
                    <button
                        class="w-full bg-orange-500 text-white font-bold rounded-full py-2 text-sm hover:bg-orange-600">DAFTAR</button>
                </form>
            </div>

            <!-- Bagian Kanan -->
            <div
                class="w-[55%] bg-gradient-to-b from-orange-500 to-orange-400 text-white flex flex-col items-center justify-center relative p-6">
