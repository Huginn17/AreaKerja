    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-orange-600 dark:bg-gray-800 ">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ url('/finance/paketharga') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 group">
                        <svg width="20" height="21" viewBox="0 0 20 21" fill="none"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <mask id="mask0_679_15285" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                                width="20" height="21">
                ...
                <li>
                    <a href="{{ url('/finance/omset/perusahaan') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 group">
                        <svg width="20" height="21" viewBox="0 0 20 21" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap text-white hover:text-orange-500">Omset
                            Perusahaan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ url('/finance/catatan/transaksi') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 group">
                        <svg width="14" height="19" viewBox="0 0 14 19" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M1 6.3C1 4.0376 1 2.9056 1.65925 2.2032C2.31775 1.5 3.379 1.5 5.5 1.5H8.5C10.621 1.5 11.6823 1.5 12.3408 2.2032C13 2.9056 13 4.0376 13 6.3V12.7C13 14.9624 13 16.0944 12.3408 16.7968C11.6823 17.5 10.621 17.5 8.5 17.5H5.5C3.379 17.5 2.31775 17.5 1.65925 16.7968C1 16.0944 1 14.9624 1 12.7V6.3Z"
                                stroke="white" stroke-width="1.5" />
                            <path
                                d="M12.9235 12.7002H3.9235C3.226 12.7002 2.87725 12.7002 2.59075 12.7818C2.20923 12.8909 1.86137 13.1053 1.58213 13.4032C1.3029 13.7012 1.10212 14.0724 1 14.4794"
                                stroke="white" stroke-width="1.5" />
                            <path
                                d="M4 5.5H10M4 8.3H7.75M7.75 12.7V15.524C7.75 15.7448 7.75 15.8552 7.67875 15.9C7.6075 15.9448 7.51075 15.8952 7.31575 15.796L6.38425 15.324C6.31825 15.292 6.28525 15.2744 6.25 15.2744C6.21475 15.2744 6.18175 15.2912 6.11575 15.3248L5.18425 15.7968C4.98925 15.8952 4.89175 15.9448 4.82125 15.9C4.75 15.8552 4.75 15.7448 4.75 15.524V13.06"
                                stroke="white" stroke-width="1.5" stroke-linecap="round" />
                        </svg>

                        <span class="flex-1 ms-3 whitespace-nowrap text-white hover:text-orange-500">Catatan
                            Transaksi</span>
                    </a>
                </li>
                <li>
                    <a href="{{ url('/finance/laporan/transaksi2') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 group">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap text-white hover:text-orange-500">Laporan
                            Transaksi</span>
                    </a>
                </li>
                <li>
