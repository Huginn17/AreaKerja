    ...
    <main class="flex-1 p-6 bg-white overflow-y-auto">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-2 bg-white px-1 py-2 border border-gray-500 shadow-md rounded-2xl">
                    <a href="#">
        ...
        <div class="w-full h-80 bg-orange-600 rounded-lg shadow-md p-6 text-white">
            <div class="flex items-center ml-20 mt-3 gap-4">
                <!-- Foto -->
                <img src="{{ asset('images/ohim.jpg') }}" alt="Foto"
                    class="w-28 h-28 rounded-full">
                <!-- Nama -->
                <h2 class="text-2xl font-semibold ml-2">Ariefin Cahya Nugroho</h2>
            </div>

            <!-- Info -->
            <div class="grid grid-cols-3 text-center gap-16 mt-14 text-md">
                <div>
                    <p class="font-medium mr-14 mb-4">Divisi</p>
                    <p class="ml-1">Programmer</p>
                </div>
                <div>
                    <p class="font-medium mb-4">Mulai Pelatihan</p>
                    <p class="ml-1">20 Oktober 2023</p>
                </div>
                <div>
                    <p class="font-medium mr-2 mb-4">Selesai Pelatihan</p>
                    <p class="ml-1">20 Desember 2023</p>
                </div>
            </div>
        </div>
        <div class="flex flex-col items-center gap-3 mt-8">
            <button class="bg-green-600 hover:bg-green-700 py-2 px-[25%] text-white font-semibold rounded-md shadow">
                Lulus
            </button>
            <button class="bg-red-600 hover:bg-red-700 text-white py-2 px-[24.5%] font-semibold rounded-md shadow">
                Gugur
            </button>
        </div>
    </main>
