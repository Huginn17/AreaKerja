...
<rect width="25.3967" height="27.7315" fill="white" transform="matrix(0.985722 -0.168378 0.179073 0.983836 0.164062 4.27539)"/>
    ...
    <div class="border border-gray-500 rounded-xl p-16 max-w-3xl mx-auto">
      ...
      <form class="space-y-6">
        ...
        <div class="grid grid-cols-2 gap-6">
          <div>
            <label for="judul" class="block text-medium font-bold mb-1">Judul <span class="text-red-600">*</span></label>
            <select type="text" id="judul" name="judul" required class=" w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500">
          ...
          <div>
            <label for="alamat" class="block text-sm  text-medium  font-bold mb-1">Alamat <span class="text-red-600">*</span></label>
        ...
        <div class="grid grid-cols-5 gap-4 items-end">
          <div class="col-span-2">
            <label for="jenis" class="block text-sm font-bold text-medium  mb-1">Jenis Lowongan <span class="text-red-600">*</span></label>
          ...
          <div class="col-span-1">
            <label for="gaji-min" class="block text-sm font-bold text-medium  mb-1">Gaji <span class="text-red-600">*</span></label>
        ...
        <!-- Deskripsi -->
        <div>
          <label for="deskripsi" class="block text-sm font-bold text-medium  mb-1">Deskripsi <span class="text-red-600">*</span></label>
  ...
  <label class="w-32 text-sm font-semibold  text-medium pt-1">Pendidikan <span class="text-red-600">*</span></label>
  ...
  <input
    ...
    class="flex-1 border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-orange-500"/>
        ...
        <div class="mb-4 flex items-start">
  <!-- Label -->
  <label class="w-32 text-sm font-semibold text-medium  pt-1">Gender <span class="text-red-600">*</span></label>
