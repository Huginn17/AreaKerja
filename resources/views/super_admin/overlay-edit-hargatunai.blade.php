...
<div class="px-15 pb-5">
    ...
    <table class="min-w-full text-base">
      ...
      <tbody class="divide-y divide-gray-200">
        <tr>
          ...
          <td class="px-4 py-3 text-right font-semibold"><span class="bg-gray-300 text-black text-sm font-semibold px-3 py-1 rounded-md">
  Rp. 200.000
</span>
</td>
        </tr>
  ...
  Rp. 100.000
        ...
        <tr>
          <td class="px-4 py-3 font-semibold">Top Up 1000 Koin Areakerja</td>
    <td class="px-4 py-3 text-right font-semibold"><span class="bg-gray-300 text-black text-sm font-semibold px-3 py-1 rounded-md">Rp. 500.000
</span>
</td>
        </tr>
        <tr>
  ...
  Rp. 1.000.000
        ...
        <tr>
          <td class="px-4 py-3 font-semibold">Top Up 100.000 Koin Areakerja</td>
          <td class="px-4 py-3 text-right font-semibold"><span class="bg-gray-300 text-black text-sm font-semibold px-3 py-1 rounded-md">
  Rp. 1.500.000
</span>
</td>
