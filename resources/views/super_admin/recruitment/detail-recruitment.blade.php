            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="flex items-center gap-4 mb-8">
                    <img src="{{ asset('storage/' . $recruitment->pelamar->img_profile) }}"
                        class="w-20 h-20 rounded-full border mr-1" />

                    <div>
                        <h2 class="text-lg font-bold">{{ $recruitment->pelamar->nama_pelamar }}</h2>
                ...
                <div class="grid grid-cols-2 gap-6 text-sm">
                    ...
                    <div>
                        ...
                        <p class="mb-3">{{ $recruitment->pelamar->telepon_pelamar }}</p>

                        <p class="font-semibold mb-3">Social Media</p>

                        <p class="m-1">
                            Instagram <span class="ml-8"> :
                    ...
                    <div>
                        ...
                        <p class="mb-3">{{ $recruitment->pelamar->user->username }}</p>
                        <p><span class="font-semibold">Email</span></p>
                        <p class="mb-3">{{ $recruitment->pelamar->user->email }}</p>
                ...
                <div class="mt-4 text-sm">
                    ...
                    @foreach ($recruitment->pelamar->pengalaman_organisasi as $o)
                        <p class="mb-1">{{ $loop->iteration }}. {{ $o->nama_organisasi }}
                            <span class="ml-11"> {{ $o->jabatan }}</span> <span class="ml-10">
                ...
                <div class="mt-4 text-sm">
                    ...
                    @foreach ($recruitment->pelamar->pengalaman_kerja as $k)
                        <p class="mb-1">{{ $loop->iteration }}. {{ $k->posisi_pekerjaan }}
                            <span class="ml-12"> {{ $k->nama_perusahaan }}</span> <span class="ml-10">
                                {{ $recruitment->lowongan_perusahaan->perusahaan->alamatUtama->kota->nama ?? '-' }}
                            </span><span class="ml-10">{{ $k->tahun_awal }}–{{ $k->tahun_akhir }}</span>
                        </p>
                        </p>
                    @endforeach
                </div>
                ...
                <div class="mt-4 text-sm">
                    ...
                    @foreach ($recruitment->pelamar->riwayat_pendidikan as $p)
                        <p class="mb-1">{{ $loop->iteration }}. {{ $p->asal_pendidikan }}
                            <span class="ml-24"> {{ $p->jurusan }}</span> <span
                                class="ml-8">{{ $p->tahun_awal }}–{{ $p->tahun_akhir }}</span>
                        </p>
                        </p>
                    @endforeach
                </div>
            ...
            <div>
                <div class="max-w-5xl mx-auto bg-white p-10 text-gray-800">
                        ...
                        <div class="space-y-8">
                            ...
                            <section>
                                ...
                                <p style="margin-top: 0; margin-bottom: 24px;" class="text-sm">
                                    ...
                                    besar dalam pengembangan web dan aplikasi. Dengan keahlian dalam Flutter untuk
                                    pengembangan aplikasi berbasis Android serta PHP untuk pemrograman web, saya terus
                                    mengasah kemampuan saya di bidang teknologi. Saya bercita-cita menjadi seorang
                                    programmer full-stack yang mampu mengembangkan aplikasi atau website sendiri, dengan
                                    harapan dapat memberikan kontribusi positif bagi masyarakat dalam menghadapi
                            ...
                            <section>
                                ...
                                <section>
                                    ...
                                    <h4 class="text-sm">Sebagai anggota Tim Kreatif, saya bertanggung jawab dalam
                                        menghasilkan konsep kreatif untuk berbagai kegiatan dan acara yang diselenggarakan
                                        oleh himpunan. Saya berkolaborasi dengan tim untuk merancang desain visual, materi
                                        promosi, serta konten media sosial yang menarik dan efektif dalam menyampaikan pesan
                                    ...
                                    <h4 class="text-sm">
                                        ...
                                        Tugas saya meliputi penyusunan strategi komunikasi, penyebaran informasi terkait
                                        kegiatan BEM melalui berbagai platform, seperti media sosial, website, dan publikasi
                                        langsung.
                                    </h4>
                                </section>
                        </div>
                                ...
                                <div class="mt-3 space-y-4 text-sm">
                                    <div>
                                        <p style="margin: 0 0 14px 0;">
                                            ...
                                            saya menggunakan tools seperti Figma dan Adobe XD untuk membuat wireframing,
                                            prototype, serta user flow efektif.
                                        </p>
                                        ...
                                        <p style="margin: 0 0 14px 0; clear: both;">
                                            ...
                                            berfungsi dengan baik di sisi klien. Saya menggunakan teknologi seperti HTML,
                                            CSS, JavaScript, serta framework seperti React dan Vue.js untuk membangun
                                            antarmuka pengguna yang responsif dan interaktif.
                                        </p>
                                        ...
                                        <p style="margin: 0 0 14px 0; clear: both;">
                                            ...
                                            data, serta logika aplikasi di sisi server. Saya menggunakan bahasa pemrograman
                                            seperti PHP dan Node.js untuk membangun API dan sistem back-end yang handal,
                                            efisien, dan aman. Saya juga bertanggung jawab untuk memastikan data yang diolah
                                            dapat diakses secara cepat dan aman oleh pengguna melalui front-end, serta
                                            memastikan aplikasi dapat berkembang dengan baik seiring dengan meningkatnya
                    ...
                    <div class="flex flex-col items-center justify-center mt-10 text-sm font-semibold text-gray-800">
                        <img src="{{ asset('images/logoarea.png') }}" alt="Logo Areakerja" class="w-20 h-auto mb-1">
