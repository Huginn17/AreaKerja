...
<rect width="25.3967" height="27.7315" fill="white" transform="matrix(0.985722 -0.168378 0.179073 0.983836 0.162109 4.27637)"/>
</clipPath>
</defs>
...
<br>
<br>
<div style="max-width: 820px; margin: 60px auto 80px 380px; font-family: Arial, sans-serif; color: #222; position: relative;">

  <!-- Tombol Close -->
  <div style="position: absolute; top: 15px; right: 10px; cursor: pointer; font-weight: medium; font-size: 40px; color: #555;">×</div>
  ...
  <tr>
    <td valign="top" style="padding-right: 40px; text-align: center;">
      <img src="https://avatar.iran.liara.run/public/boy" width="110" height="110" style="border-radius: 50%; object-fit: cover;" alt="Foto Profil"/>
    </td>
    <td valign="top" style="padding-right: 40px;">
      <div style="font-weight: bold; font-size: 30px; color: #f97316;" >Bambang Kurnia</div>
      <div style="font-size: 12px; ">
        <br><div class="text-sm font-semibold">Jalan Prapatan Dalam No. 04 RT. 47
  ...
  <table cellpadding="2" cellspacing="0" border="0">
    <tr>
      <td style="color: #f97316;"><svg width="17" height="12" viewBox="0 0 17 12" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M16.6779 3.9625C16.8074 3.86563 17 3.95625 17 4.10938V10.5C17 11.3281 16.2861 12 15.4062 12H1.59375C0.713867 12 0 11.3281 0 10.5V4.1125C0 3.95625 0.189258 3.86875 0.32207 3.96562C1.06582 4.50937 2.05195 5.2 5.43867 7.51562C6.13926 7.99687 7.32129 9.00938 8.5 9.00313C9.68535 9.0125 10.8906 7.97813 11.5646 7.51562C14.9514 5.2 15.9342 4.50625 16.6779 3.9625ZM8.5 8C9.27031 8.0125 10.3793 7.0875 10.9371 6.70625C15.3432 3.69688 15.6785 3.43437 16.6945 2.68437C16.8871 2.54375 17 2.325 17 2.09375V1.5C17 0.671875 16.2861 0 15.4062 0H1.59375C0.713867 0 0 0.671875 0 1.5V2.09375C0 2.325 0.112891 2.54062 0.305469 2.68437C1.32148 3.43125 1.65684 3.69688 6.06289 6.70625C6.6207 7.0875 7.72969 8.0125 8.5 8Z" fill="#FA6601"/>
</svg>
</td>
      <td  style="padding-left: 8px;" class="text-sm font-sm">bambangkurnia@gmail.com</td>
...
<div style="max-width: 900px; margin: 40px auto; font-family: Arial, sans-serif; color: #222; line-height: 1.5; font-size: 12px;">
...
<rect width="335" height="1" fill="#FA6601"/>
        ...
        <div style="width: 40px; height: 5px; background-color: #f97316; margin-bottom: 20px;"><svg width="335" height="1" viewBox="0 0 335 1" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect width="335" height="1" fill="#FA6601"/>
</svg>
</div>
  ...
  <strong style="display: inline-block; margin-bottom: 6px text-sm">BEM KM UGM</strong><br>
...
<rect width="335" height="1" fill="#FA6601"/>
        ...
        <p style="margin: 0 0 14px 0;">
          <b class="text-sm">Jabatan – UI/UX Designer</b> <span style="float: right;"><b>(2020–2022)</b></span><br>
        ...
        <p style="margin: 0 0 14px 0; clear: both;">
          <b class="text-sm">Jabatan – Front End Developer</b> <span style="float: right;"><b>(2022–2023)</b></span><br>
        ...
        <p style="margin: 0 0 14px 0; clear: both;">
          <b class="text-sm">Jabatan – Back End Developer</b> <span style="float: right;"><b>(2023–2024)</b></span><br>
        ...
        <div style="font-weight: 700; font-size: 18px; color: #f97316; margin-bottom: 8px; margin-top: 40px;">LATAR BELAKANG PENDIDIKAN</div>
        <div style="width: 40px; height: 5px; background-color: #f97316; margin-bottom: 16px;"><svg width="335" height="1" viewBox="0 0 335 1" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect width="335" height="1" fill="#FA6601"/>
</svg>
</div>
  ...
  <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; margin-top: 40px; font-size: 12px; color: #222;">
    <img src="{{ asset('images/logoarea.png') }}" alt="Logo Areakerja" style="width: 80px; height: auto; margin-bottom: 4px;" >
