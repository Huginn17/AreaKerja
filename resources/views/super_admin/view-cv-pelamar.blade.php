                ...
                <tr>
                    ...
                    <td valign="top" style="padding-right: 40px;">
                        ...
                        <div style="font-size: 12px; ">
                            <br>
                            <div class="text-sm font-semibold">Jalan Prapatan Dalam No. 04 RT. 47
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr valign="top">
                        ...
                        <td width="50%">
                            ...
                            <div style="width: 40px; height: 5px; background-color: #f97316; margin-bottom: 20px;"><svg
                                    width="335" height="1" viewBox="0 0 335 1" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <rect width="335" height="1" fill="#FA6601" />
                                </svg>
                            ...
                            <p style="margin: 0 0 8px 0; clear: both;">
                                ...
                                sebagai anggota Divisi Humas BEM KM UGM, saya berperan dalam menjaga komunikasi yang baik
                                antara organisasi dengan mahasiswa, pihak universitas, serta masyarakat umum. Tugas saya
                                meliputi penyusunan strategi komunikasi, penyebaran informasi terkait kegiatan BEM melalui
                                berbagai platform, seperti media sosial, website, dan publikasi langsung.
                            </p>
                        ...
                        <td width="50%" style="padding-left: 30px;">
                            ...
                            <p style="margin: 0 0 14px 0; clear: both;">
                                <b class="text-sm">Jabatan – Front End Developer</b> <span style="float: right;"><b
                                        class="text-sm">(2022–2023)</b></span><br>
