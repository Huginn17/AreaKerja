        ...
        <div class="max-w-5xl mx-auto bg-white border border-gray-400 rounded-lg p-6 shadow-sm">
            ...
            <div class="flex items-center gap-4 mb-6">
                ...
                <div class="ml-2">
                    ...
                    <p class="text-black text-sm">lutung123@gmail.com</p>
                </div>
                <div class="flex flex-col gap-3 scale-90">
                    <button
                        class="flex items-center gap-2 px-4 py-2 text-sm border-2 border-orange-600 bg-orange-600 text-white rounded-md">
                        <!-- Icon upload -->
                    ...
                    <button
                        class="flex items-center gap-2 px-4 py-2 mt-1 text-sm border-2 border-orange-600 text-orange-600 rounded-md hover:bg-gray-100">
                        <!-- Icon trash -->
            ...
            <form class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" value="lutung123@gmail.com"
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" value="Muchammad Abdurohim"
                        class="w-full border text-black border-gray-300 shadow rounded-md px-3 py-2 focus:ring-2 focus:ring-orange-500 focus:outline-none">
                </div>
