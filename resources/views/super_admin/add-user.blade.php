                        ...
                        <tr class="border-b border-orange-600">
                            ...
                            <td class="px-4 py-2">
                                <div class="flex gap-2">
                                    <button class="bg-orange-600 text-white p-2 rounded"><img src="{{ asset('images/trash.png') }}" alt="trash" class="te"></button>
                                    <button class="bg-orange-600 text-white p-2 rounded"><i
