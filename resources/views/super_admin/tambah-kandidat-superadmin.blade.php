...
@section('sidebarsuperadmin')
    <main class="flex-1 p-6 bg-white overflow-x-auto">
        ...
        <div class="max-w-6xl mx-auto p-6 bg-white border border-gray-400 rounded-2xl shadow-md">
            <h2 class="text-lg font-semibold mb-10">Edit Kandidat</h2>
            <!-- Header -->
            ...
            <form class="space-y-4">
                ...
                <!-- Pendidikan -->
                <div>
                    <label class="block text-md font-medium mb-1">Pendidikan <span class="text-red-500">*</span></label>
                    <button type="button"
                ...
                <!-- Organisasi -->
                <div>
                    <label class="block text-md font-medium mb-1">Organisasi <span class="text-red-500">*</span></label>
                    <button type="button"
                        class="w-full flex justify-between items-center bg-orange-500 text-white px-4 py-2 rounded-lg">
                ...
                <!-- Pengalaman -->
                <div>
                    <label class="block text-md font-medium mb-1">Pengalaman <span class="text-red-500">*</span></label>
                    <button type="button"
                        class="w-full flex justify-between items-center bg-orange-500 text-white px-4 py-2 rounded-lg">
                ...
                <!-- Skill -->
                <div>
                    <label class="block text-md font-medium mb-1">Skill <span class="text-red-500">*</span></label>
                    <button type="button"
                        class="w-full flex justify-between items-center bg-orange-500 text-white px-4 py-2 rounded-lg">
                        Tambahkan Skill
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
