        ...
        <div class="w-full max-w-4xl mx-auto mt-10 px-6 overflow-y-auto translate-x-30">
            ...
            <div
                ...
                <form class="space-y-5">
                    <!-- Nama Perusahaan -->
                    <div>
                        <label class="block text-sm font-semibold text-gray-700">Nama Perusahaan<span
                                class="text-red-500">*</span></label>
                        <input type="text"
                            class="w-full border border-gray-400 rounded-md px-3 py-2 mt-1 focus:outline-none" />
                    </div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Deskripsi Perusahaan<span
                                class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Posisi yang dibutuhkan<span
                                class="text-red-500">*</span></label>
                        <input type="text" class="w-full border border-gray-400 rounded-md px-3 py-2 mt-1" />
                    </div>
                        ...
                        <div class="flex space-x-4">
                            ...
                            <label class="flex items-center space-x-2">
                                <input type="radio"name="gender"
                                    class="h-4 w-4 border-2 border-orange-400 text-orange-500 focus:ring-orange-500 focus:border-orange-500" />
                    ...
                    <!-- Gaji -->
                    <div class="mb-4">
                        <label class="block font-semibold text-gray-800 text-sm mb-1">Gaji<span
