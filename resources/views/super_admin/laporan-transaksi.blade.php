...
@section('sidebar')
    <div class="max-w-5xl sm:ml-64 mx-auto p-6 translate-x-40 overflow-y-auto">
        <!-- Header -->
        ...
        <!-- Submenu Button -->
        <select class="bg-orange-500 text-white px-4 py-2 rounded-md font-medium focus:outline-none mb-4">
