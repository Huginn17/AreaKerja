...
@section('sidebarsuperadmin')
    <main class="flex-1 p-6 sm:ml-64 bg-white overflow-y-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-medium">Data Request Panggilan</h1>
            <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-2 bg-white px-3 py-2 border border-gray-300 shadow-md rounded-2xl">
                    <a href="#">
                        <img src="{{ asset('images/ngobrol1.jpg') }}" class="w-8 h-8 rounded-full" alt="User">
                    </a>
                    <div class="text-sm">
