...
@section('sidebarsuperadmin')
    <main class="flex-1 p-6 sm:ml-64 bg-white overflow-x-auto">
        ...
        <div class="max-w-6xl mx-auto p-6 bg-white border-2 border-gray-400 rounded-2xl shadow-md">
            <h2 class="text-lg font-semibold mb-10">Edit Kandidatzzz</h2>
            <!-- Header -->
            <div class="flex items-center justify-between mb-10">
                <div class="flex items-center gap-2">
                    <img src="{{ asset('images/ngobrol2.jpg') }}" alt="avatar"
            ...
            @if (!$pelamar)
                <div class="bg-yellow-100 text-yellow-800 p-3 rounded-lg mb-4">
                    ⚠️ Harap buat data pelamar terlebih dahulu sebelum mengisi sosial media.
                </div>
            @endif
            ...
            <form action="{{ route('superadmin.pelamar.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <input type="text" class="w-full mt-1 border-2 border-gray-400 shadow rounded-lg px-3 py-2"
                        placeholder="Alamat" />
                </div>
