...
@section('content')
    ...
    <h3 class=" px-40 mt-8 text-gray-500 font-semibold dark:text-white">Lowongan berdasarkan pada aktivitas Anda di
        areakerja</h3>
    <section class="max-w-5xl mx-auto px-4 py-8 grid md:grid-cols-2 gap-6">
        ...
        <div class="bg-white border rounded-2xl shadow-sm p-5">
            ...
            <p class="text-gray-500 text-sm mt-2">Capital Club <br>
            <p class="mt-1 text-gray-500 text-sm">Jakarta</p>
            </p>
        ...
        <div class="flex flex-col md:flex-row gap-7 items-center" style="padding-left: 440px">
            <button
                class="px-10 py-2 bg-orange-500 text-white rounded-md text-sm hover:bg-orange-600 font-medium transition duration-300">
                Memuat
            </button>
        </div>
    </section>
