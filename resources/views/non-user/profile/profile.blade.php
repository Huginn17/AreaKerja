            ...
            <div class=" border-orange-500 border-rounded-lg p-8 flex items-center justify-between">
                ...
                <div class="flex items-center gap-8">
                    ...
                    <div class="flex flex-col items-center">
                        <div class="relative">
                            <img src="cwe.png" alt="Profile" class="w-20 h-20 rounded-full object-cover border" />
                ...
                <div class="flex items-center gap-2">
                    <button class="bg-orange-500 text-white text-sm font-semibold px-4 py-2 rounded hover:bg-orange-600">
                        Unduh CV
                    </button>
                    <button class="bg-green-600 text-white text-sm font-semibold px-4 py-2 rounded hover:bg-green-700">
                        Simpan
                    </button>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            border border-orange-500 text-white rounded-md text-sm">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <label class="text-sm font-medium"> nkedin<span class="text-red-500"></span></label>
