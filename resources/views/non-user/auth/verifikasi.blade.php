...
<body class="bg-gray-100">
  ...
  <section class="relative h-screen w-2/4">
    ...
    <div class="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-6">
      ...
      <p class="text-sm mb-10">untuk tetap terhubung dengan kami, silakan<br> masuk dengan informasi pribadi Anda</p>
    ...
    <div class="flex w-full md:w-4/2 bg-white items-center justify-center">
      <div class="w-full max-w-md p-8">
        ...
        <p class="text-center text-gray-500 mb-6 mt-6 text-sm">kata sandi Anda akan diatur ulang melalui email</p>
