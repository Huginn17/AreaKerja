...
@section('content')
    <div class="max-w-3xl mx-auto py-8">
        ...
        <div class="max-w-3xl mx-auto p-4">
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <div class="flex items-center gap-4 text-sm text-gray-600">
                    <button class="bg-orange-500 hover:bg-orange-600 text-white p-2 px-3 rounded-full">
                        ➔
                    </button>
        ...
        <!-- Floating Button -->
        <a href="#top"
            class="fixed bottom-6 right-6 bg-orange-500 hover:bg-orange-600 text-white p-2 px-4 rounded-full shadow-lg">
            ↑
        </a>
    </div>
