        ...
        <main class="flex-1 p-6 bg-white overflow-y-auto">
            ...
            <div class="flex items-center justify-between pb-6">
                ...
                <div class="flex items-center gap-4 overflow-y-auto">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-orange-600 mb-1">{{ $user->username }} </h1>
            ...
            <div class="grid md:grid-cols-2 gap-8 mt-8">
                ...
                <div class="space-y-8">
                    ...
                    <!-- Tentang Saya -->
                    <section>
                        <div style="font-weight: 700; font-size: 18px; color: #f97316; margin-bottom: 8px;">TENTANG SAYA
                        </div>
                    ...
                    <section>
                        ...
                        <section>
                            ...
                            <h4 class="text-sm">Sebagai anggota Tim Kreatif, saya bertanggung jawab dalam menghasilkan
                                ...
                                konten media sosial yang menarik dan efektif dalam menyampaikan pesan kepada anggota dan
                                masyarakat.
                            </h4><br>
                            ...
                            <p style="margin: 0 0 8px 0; clear: both;">
                                ...
                                <strong style="display: inline-block; margin-bottom: 6px text-sm">BEM KM UGM</strong>
                            <h4 class="text-sm">
                        ...
                        <div class="mt-3 space-y-4 text-sm">
                            <div>
                                <p style="margin: 0 0 14px 0;">
                                    ...
                                    elemen desain tidak hanya estetis tetapi juga fungsional. Dalam pekerjaan ini, saya
                                    menggunakan tools seperti Figma dan Adobe XD untuk membuat wireframing, prototype,
                                ...
                                <p style="margin: 0 0 14px 0; clear: both;">
                                    ...
                                    <br> Bertugas untuk mengimplementasikan desain UI/UX ke dalam kode yang berfungsi
                                    dengan baik di sisi klien. Saya menggunakan teknologi seperti HTML, CSS, JavaScript,
                                    serta framework seperti React dan Vue.js untuk membangun antarmuka pengguna yang
                                    responsif dan interaktif.
                                </p>

                                <p style="margin: 0 0 14px 0; clear: both;">
                                    <b class="text-sm">Jabatan – Back End Developer</b> <span style="float: right;"><b
                                            class="text-sm">(2023–2024)</b></span><br>
                                    <b class="text-sm">PT. Haryanto Group</b>
                                    <br> Fokus utama saya adalah pada pengembangan dan pengelolaan server, basis data,
                                    serta logika aplikasi di sisi server. Saya menggunakan bahasa pemrograman seperti
                                    PHP dan Node.js untuk membangun API dan sistem back-end yang handal, efisien, dan
                                    aman. Saya juga bertanggung jawab untuk memastikan data yang diolah dapat diakses
                                    secara cepat dan aman oleh pengguna melalui front-end, serta memastikan aplikasi
                                    dapat berkembang dengan baik seiring dengan meningkatnya permintaan dan penggunaan.
                                </p>
                            </div>
                        </div>
                    </section>
