        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div class="flex items-center gap-5">
                ...
                <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    ...
                    <!-- Dropdown menu -->
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-md dark:bg-gray-700 dark:divide-gray-600"
                        id="user-dropdown">
                        <div class="px-4 py-3">
                            <span class="block text-sm text-gray-900 dark:text-white">Bonnie Green</span>
                            <span
                                class="block text-sm  text-gray-500 truncate dark:text-gray-400">Bonnie33@gmail.com</span>
                        </div>
                        <ul class="py-2" aria-labelledby="user-menu-button">
                            ...
                            <li>
                                <a href="{{ url('/bantuan') }}"
                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-red-200  hover:text-orange-500 mb-4">Bantuan</a>
                            </li>
                            <li>
                                <div class=" flex justify-center">
                                    ...
                                    <button onclick="openModal()"
                                        class="px-10 py-1 bg-orange-500 text-white rounded-lg shadow-md font-small hover:bg-orange-600 transition mb-5">
                                        Keluar
                                    </button>
                                </div>
                            </li>
