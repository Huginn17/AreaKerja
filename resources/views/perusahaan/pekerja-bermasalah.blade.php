...
<body class="bg-white text-gray-800"><br>
  ...
  <div class="flex justify-between items-center px-8 py-4">
    <button class="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white px-6 py-2 rounded-lg text-sm">
      <svg width="8" height="15" viewBox="0 0 8 15" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M6.92187 13.3327L1.08854 7.49935L6.92188 1.66602" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
 Kembali
    </button>
    <span class="bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded-xl text-sm font-semibold">
