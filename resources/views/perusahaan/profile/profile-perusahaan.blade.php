        ...
        @if (Auth::user()->perusahaan->deskripsi)
            <div class="mt-6">
                <div class="flex items-start">
                    <label class="w-32 text-sm mt-2">Deskripsi</label>
        ...
        <div class="mt-6 grid grid-cols-3 gap-6">
            ...
            <div class="col-span-2 space-y-4">
                ...
                <div class="flex items-start mt-4">
                    <label class="w-32 text-sm mt-2">Visi</label>
                    <textarea name="visi" readonly
                        class="auto-grow flex-1 border border-orange-400 rounded-md p-2 focus:outline-none resize-none overflow-hidden text-gray-800 text-sm">{{ Auth::user()->perusahaan->visi }}</textarea>
                </div>

                <!-- Misi -->
                <div class="flex items-start mt-4">
                    <label class="w-32 text-sm mt-2">Misi</label>
                    <textarea name="misi" readonly
                        class="auto-grow flex-1 border border-orange-400 rounded-md p-2 focus:outline-none resize-none overflow-hidden text-gray-800 text-sm">{{ Auth::user()->perusahaan->misi }}</textarea>
                </div>
            </div>
