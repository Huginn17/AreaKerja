...
@section('content')
    <div class="min-h-screen bg-white p-8 mt-16">
        <!-- Header -->
        ...
        <div>
            ...
            <div class="border border-orange-400 rounded-md p-6 w-[600px]">
                <div class="flex items-center gap-2 mb-8">
                    ...
                    <!-- Icon Dokumen -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-gray-500" fill="currentColor"
                        viewBox="0 0 24 24">
                        <path
                            d="M6 2C4.897 2 4 2.897 4 4V20C4 21.103 4.897 22 6 22H18C19.103 22 20 21.103 20 20V8L14 2H6zM13 9V3.5L18.5 9H13z" />
                    </svg>
                </div>
