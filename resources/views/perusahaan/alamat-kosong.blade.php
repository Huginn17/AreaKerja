 ...
 <div class="max-w-6xl mx-auto p-10 bg-white">
    ...
    <form class="space-y-6">
      ...
      <div>
        ...
        <select class="w-full border border-orange-500 rounded-md px-3 py-2 text-gray-700 placeholder-gray-400 focus:outline-none">
      ...
      <div>
        ...
        <textarea rows="4" placeholder="Detail Alamat"class="w-full border border-orange-500 rounded-md px-3 py-2 placeholder-gray-400 focus:outline-none"></textarea>
      </div>

      <!-- Tombol Batal & Simpan -->
      <div class="flex justify-end space-x-4">
        <button type="button" class="px-7 py-1 border border-orange-500 text-sm text-orange-500 rounded-md hover:bg-orange-50">
          Batal
        </button>
