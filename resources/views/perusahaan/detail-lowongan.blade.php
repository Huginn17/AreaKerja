        ...
        <div class="flex gap-10">
            ...
            <div class="flex-1">
                ...
                <div class="flex items-center gap-4 mb-6">
                    <img src="{{ asset('images/seven.png') }}" alt="Seven Logo" class="w-20 h-auto" />
                    <div>
                        <h2 class="font-bold text-xl">UI/UX Designer</h2>
                        <p class="text-sm text-gray-500">Seven Inc · Jasa TI dan Konsultan TI</p>
                        <p class="text-sm mt-1 text-gray-500">Jakarta Timur, DKI Jakarta, Indonesia</p>
                        <p class="mt-1 text-gray-700 font-semibold">Rp. 7.000.000 - Rp. 15.000.000 per bulan</p>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <p class="mb-3 text-gray-600">Berikut merupakan deskripsi lengkap terkait perusahaan yang anda tuju</p>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <span class="inline-block bg-gray-200 text-gray-700 rounded px-3 py-1 text-xs mt-2">Full
                                time</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <ul class="list-disc list-inside text-gray-700 mt-2 space-y-1">
                        <li>Minimal 2 tahun pengalaman sebagai UX/UI Designer atau posisi serupa.</li>
                        <li>Portofolio/proyek desain grafis terkait aplikasi web & seluler.</li>
                        <li>Mampu problem solving bersama web designer menggunakan HTML5 &amp; CSS3.</li>
                        <li>Paham wireframing, komunikasi yang baik, dan teamwork.</li>
                        <li>Berpengalaman pada desain responsif & interaktif.</li>
                    </ul>
                </div>
                ...
                <div class="mb-2">
                    ...
                    <ul class="list-disc list-inside text-gray-700 space-y-1">
                        <li>Mengumpulkan & memprioritaskan kebutuhan pengguna.</li>
                        <li>Kolaborasi dengan engineer dan product designer.</li>
                        <li>Mengembangkan desain visual untuk web, mobile, dan produk digital.</li>
                        <li>Menggunakan sitemap, flowchart, dan storyboard untuk ide & ilustrasi.</li>
                        <li>Merancang UI (menu, widget, tab, dll.).</li>
                        <li>Membuat mockup & prototipe UI.</li>
                        <li>Menjaga konsistensi copy, tone, filter, gambar, dan elemen grafis.</li>
                        <li>Mempresentasikan desain ke tim & stakeholder.</li>
                        <li>Iterasi sesuai feedback klien.</li>
                        <li>Menerapkan prinsip UX: alur, tone, tipografi, dsb.</li>
                        <li>Memelihara sistem yang sudah berjalan.</li>
                        <li>Mengelola pengembangan teknologi aplikasi untuk UX.</li>
                        <li>Update tren dan teknologi desain terkini.</li>
                    </ul>
            ...
            <aside class="w-96">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="font-semibold text-md">Lowongan Seven Inc Lainnya</h3>
                    <a href="#" class="font-semibold text-orange-600 hover:underline text-xs">Lihat semua</a>
                </div>

                <!-- Card Item (template) -->
                <a href="#" class="block shadow-md rounded-md p-3 mb-3 hover:shadow-lg transition duration-200">
                    <div class="flex items-center gap-3">
                        <img src="{{ asset('images/seven.png') }}" alt="Logo" class="w-12 h-auto" />
                        <div class="min-w-0">
                            <p class="text-xs text-gray-600">Seven Inc</p>
                            <h4 class="font-bold text-sm truncate">Lead Graphic Designer - WFH</h4>
                ...
                <!-- Item 2 -->
                <a href="#" class="block rounded-md p-3 mb-3 hover:shadow-lg shadow-md transition duration-200">
                    <div class="flex items-center gap-3">
                        <img src="{{ asset('images/seven.png') }}" alt="Logo" class="w-12 h-auto" />
                        <div class="min-w-0">
                            <p class="text-xs text-gray-600">Seven Inc</p>
                            <h4 class="font-bold text-sm truncate">Frontend Engineer (React)</h4>
                            <p class="text-xs text-gray-600">Yogyakarta</p>
                            <div class="mt-1">
                                <span
                                    class="inline-block bg-gray-200 border rounded px-3 py-1 text-xs text-gray-700 whitespace-nowrap">
                ...
                <a href="#" class="block rounded-md p-3 mb-3 hover:shadow-lg shadow-md transition duration-200">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="min-w-0">
                            <p class="text-xs text-gray-600">Seven Inc</p>
                            <h4 class="font-bold text-sm truncate">Product Designer (Mobile)</h4>
                            <p class="text-xs text-gray-600">Yogyakarta</p>
                            <div class="mt-1">
                                <span
                                    class="inline-block bg-gray-200 border rounded px-3 py-1 text-xs text-gray-700 whitespace-nowrap">
                ...
                <a href="#" class="block rounded-md p-3 mb-3 hover:shadow-lg shadow-md transition duration-200">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="min-w-0">
                            <p class="text-xs text-gray-600">Seven Inc</p>
                            <h4 class="font-bold text-sm truncate">UI Designer (Intern)</h4>
                            <p class="text-xs text-gray-600">Yogyakarta</p>
                            <div class="mt-1">
                                <span
                                    class="inline-block bg-gray-200 border rounded px-3 py-1 text-xs text-gray-700 whitespace-nowrap">
                        ...
                        <p class="ml-auto self-start text-xs text-gray-600 whitespace-nowrap">Aktif 3 jam lalu</p>
                    </div>
                </a>
            </aside>
