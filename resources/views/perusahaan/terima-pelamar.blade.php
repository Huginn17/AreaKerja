            ...
            <form class="space-y-5">
                ...
                <div style="display:flex; align-items:center; gap:10px; margin-bottom:20px;">
                    ...
                    <div style="position:relative; display:inline-block;">
                        <select
                            style="width:70px; padding:6px; font-size:14px; border:1px solid #ccc; border-radius:6px; appearance:none; background:white; text-align:center; cursor:pointer;">
                            <option>00</option>
                            <option>01</option>
                            <option>02</option>
                            <option>03</option>
                        ...
                        <svg style="position:absolute; right:10px; top:50%; transform:translateY(-50%); pointer-events:none;"
                            width="16" height="16" viewBox="0 0 24 24" fill="orange">
                ...
                <textarea
                    style="width:100%; padding:8px 10px; font-size:14px; border:1px solid #ccc; border-radius:6px; margin-bottom:20px; resize:none; min-height:70px;">Jl. Mangga dua No. 27 RT/RW 001/003, Kecamatan Mangga, Kota Jakarta Timur, Provinsi DKI Jakarta, 13463</textarea>
