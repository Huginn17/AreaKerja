...
@section('content')
    <div class="max-w-4xl scale-90 mx-auto bg-white px-14 py-12 rounded-xl shadow border">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            ...
            <!-- Rekening Tujuan -->
            <div class="border rounded-lg p-5  text-left shadow-sm">
                <p class="text-gray-500 text-sm mb-6">Bayar Melalui</p>
                <div class="gap-3 mb-6">
                    <img src="{{ asset('images/tunggukiris.png') }}" alt="BCA Logo" class="w-20 h-8">
                </div>
                <p class="font-semibold text-lg mb-1">QRIS</p>
                <p class="text-gray-500 text-sm mb-3 flex items-center gap-1 cursor-pointer">
                    NMID : ID112233445566778
                ...
                <img src="{{ asset('images/barcode.jpg') }}" alt="" class="w-28 h-28">
            </div>
        </div>
        ...
        <div class="w-full">
            ...
            <div class="flex items-center justify-between py-3 border-b-2 border-gray-300">
                <span class="font-medium text-md">QRIS</span>
                <svg width="14" height="7" viewBox="0 0 14 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0.335938 0.332031L7.0026 6.9987L13.6693 0.332031H0.335938Z" fill="#FA6601" />
                </svg>
            </div>
            <div class="text-xs mt-4 ml-8 text-gray-900">
                <p>
                    1.  Pilih pembayaran menggunakan QRIS
                </p>
                <p>
                    2. Buka aplikasi E-Wallet anda (ShoppePay, Gopay, Dana, dll.)
                </p>
                <p>
                    3. Pilih opsi pembayaran menggunakan kode / “scan kode”
                </p>
                <p>
                    4. Arahkan kamera scan anda ke kode pembayaran yang tertera di halaman web
                </p>
                <p>
                    5. Masukan PIN sandi dan akan muncul status pembayaran anda
                </p>
            </div>
        </div>
    </div>
