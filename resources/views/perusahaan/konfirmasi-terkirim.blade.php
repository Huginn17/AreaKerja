        ...
        <div class="border border-gray-300 rounded-xl p-6 bg-white shadow-sm mb-10">
            ...
            <div class="flex items-start gap-6 mb-4">
                ...
                <div>
                    ...
                    <p class="mb-4 mt-1 font-medium">Jason Statham</p>
                    <span class="font-semibold">Status :</span> <span class="font-normal">Belum Kerja</span>


                    <p class="mt-4">
                        Lamaran yang anda ajukan ke lowongan kami pada Divisi <br> Videografi telah kami
                    ...
                    <p class="mt-8">
                        <span class="font-semibold">Catatan </span class="font-semibold">: Berpakaian sopan, rapi, dengan
                        kemeja putih dan celana bahan hitam.
                        Silakan bawa CV, KTP, ijazah SMA/SMK dan Transkrip Nilai Kuliah, serta dokumen-dokumen pendukung
                        lainnya (jika ada).
                    </p>
