            ...
            <main class="max-w-3xl mx-auto mt-20 bg-white">
                ...
                <form class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="Nama Pekerja"
                    ...
                    <div>
                        ...
                        <textarea rows="4" placeholder="Contoh: Menno jarang sekali datang tepat waktu dan sering bolos kerja"
                            class="w-full border border-gray-500 rounded-md px-4 py-2 text-sm focus:outline-none"></textarea>
                    </div>
