                    ...
                    <div class="flex justify-between items-center mb-4">
                        <div class="flex space-x-4">
                            ...
                            <button type="button" onclick="setAction('update')"
                                class="bg-gray-700 hover:bg-gray-600 px-8 py-1 rounded-lg text-white">Terapkan</button>
                            <button type="button" onclick="setAction('delete')"
                                class="bg-red-600 hover:bg-red-700 text-white px-6 py-1 rounded-lg">Hapus</button>
                        </div>
                        ...
                        <div class="flex space-x-4">
                            ...
                            <button type="button" onclick="searchTable()"
                                class="bg-gray-700 hover:bg-gray-600 text-white px-9 py-2 rounded-lg">Cari</button>
                        </div>
                    </div>
                    {{-- table --}}
