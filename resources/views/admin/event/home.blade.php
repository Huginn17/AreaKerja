                ...
                <div class="block lg:flex justify-between items-center mb-4">
                    ...
                    <div class="flex items-center space-x-2 mt-0 lg:mt-0 md:mt gap-3">
                        <form method="GET" action="{{ route('admin.eventform') }}">
                            ...
                            <button type="submit"
                                class="bg-gray-700 hover:bg-gray-500 text-white px-8 py-2 rounded-md">Cari</button>
                        </form>
                    </div>
                </div>
                            ...
                            @forelse ($events as $event)
                                <tr class="text-center">
                                    ...
                                    <td class="px-6 py-3 text-blue-400 font-medium whitespace-nowrap">
                                        <a href="{{ route('admin.detail.event', $event->id) }}">{{ $event->title }}</a>
                                    </td>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
                ...
                <form id="statusForm" method="POST">
                    ...
                    <div class="flex justify-end gap-3">
                        ...
                        <button type="submit" class="px-4 py-2 bg-gray-800 text-white rounded hover:bg-gray-500">
                            Konfirmasi
                        </button>
                    </div>
                </form>
