        ...
        <div class="flex-1 p-6 bg-white overflow-y-auto">
            ...
            <div class="pl-3 mt-5">
                ...
                <div class="flex justify-end items-center space-x-4 mb-6">
                    ...
                    <a href="#" class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg text-sm">Lihat
                        Partisipan</a>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <p><i class="ph ph-link text-2xl w-[35px] h-5 inline-block"></i>Link Form: {{ $event->link_form ?? '-' }}</p>
                </div>
