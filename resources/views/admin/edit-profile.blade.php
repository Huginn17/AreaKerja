                ...
                <form action="#" method="POST" class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="email" class="w-full p-2 border border-gray-400 shadow rounded-md text-sm "
                                placeholder="Email">
                        </div>
                        {{-- username --}}
                        <div>
                            <label for="" class="block mb-1 text-sm font-medium">Username</label>
                            <input type="text" class="w-full p-2 border border-gray-400 shadow rounded-md text-sm"
                    ...
                    <div>
                        ...
                        <input type="text" class="w-[455px] p-2 border border-gray-400 shadow rounded-md text-sm"
                    ...
                    <div class="flex">
                        <div class="mr-2">
                            ...
                            <input type="text" class="w-48 p-2 shadow border border-gray-400 rounded-md text-sm"
                                placeholder="-">
                        </div>
                        <div class="ml-5">
                    ...
                    <div>
                        ...
                        <input type="text" class="w-full p-2 shadow border border-gray-400 rounded-md text-sm"
