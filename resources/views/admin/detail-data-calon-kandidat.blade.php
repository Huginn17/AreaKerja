...
@section('sidebaradmin')
    <div
        style="margin-left: 240px; padding: 40px; background-color: #ffffff; min-height: 100vh; font-family: 'Poppins', sans-serif;">

        <!-- Header -->
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
               <h1 class="text-xl font-semibold">Data Kandidat</h1>
        ...
        <!-- Kartu Kandidat -->
        <div
            style="margin: 0 auto; background-color: #5c5c5c; border-radius: 10px; color: white; padding: 50px 50px; max-width: 950px; box-shadow: 0 10px 25px rgba(0,0,0,0.2);">
            <div style="display: flex; align-items: center; margin-bottom: 50px;">
                <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Foto"
                    style="width: 90px; height: 90px; border-radius: 50%; margin-right: 25px;">
                <h3 class="ml-2 text-2xl font-medium">Ariefin Cahya Nugroho</h3>
            </div>

            <div style="display: flex; justify-content: space-between;">
                <div>
                    <div style="font-size: 16px; color: rgb(255, 253, 253);"class="mr-2 mb-2">Divisi</div>
                    <div style="font-size: 16px;">Programmer</div>
                </div>
                <div>
                    <div style="font-size: 16px; color: rgb(255, 253, 253);" class="mr-2 mb-2">Mulai Pelatihan</div>
                    <div style="font-size: 16px;">20 Oktober 2023</div>
                </div>
                <div>
                    <div style="font-size: 16px; color: rgb(255, 253, 253);" class="mr-2 mb-2">Selesai Pelatihan</div>
        ...
        <div style="margin-top: 30px; text-align: center;">
            <button
                ...
                onmouseover="this.style.backgroundColor='#86efac'" onmouseout="this.style.backgroundColor='#22c55e'">
                Lulus
            </button>
            ...
            <button
                ...
                onmouseover="this.style.backgroundColor='#f87171';" onmouseout="this.style.backgroundColor='#dc2626';">
                Gugur
            </button>
