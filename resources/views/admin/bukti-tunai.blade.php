...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="w-full max-w-[400px] bg-white shadow-md rounded-2xl p-11 text-center scale-90">
        ...
        <!-- Judul -->
        <h2 class="text-lg font-semibold mb-6">Top Up Berhasil</h2>

        <!-- Icon centang -->
        <div class="flex justify-center mb-8">
            <div class="w-16 h-16 flex items-center justify-center rounded-full bg-orange-200">
                <div class="w-12 h-12 flex items-center justify-center rounded-full bg-orange-500 text-white">
        ...
        <div class="space-y-6 text-sm text-left font-medium">
            ...
            <div class="flex justify-between">
                <span>Status</span>
                <span class="bg-orange-500 text-white px-3 py-1 rounded-full text-xs">Berhasil</span>
            </div>
            <div class="flex justify-between">
