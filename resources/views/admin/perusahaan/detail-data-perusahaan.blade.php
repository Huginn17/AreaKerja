            ...
            <div class="max-w-6xl mx-auto bg-white rounded-xl p-6 relative">
                <div class="max-w-5xl mx-auto border-2 border-gray-400 rounded-xl shadow">
                    ...
                    <div class="flex items-center border border-gray-400 rounded-xl shadow-lg py-1 gap-4 mb-4">
                        <img src="{{ $perusahaan->img_profile ? asset('storage/' . $perusahaan->img_profile) : asset('images/seven.png') }}" alt="foto kandidat" class="w-68 h-64 mr-4">
                        <div class="ml-20">
                    ...
                    <div class="max-w-4xl mx-auto bg-white p-8">
                        ...
                        <div class="text-sm font-medium space-y-2">
                            ...
                            <div>
                                <a href="{{ route('admin.lowongan.detail', $lowongan->id) }}" class="text-blue-500 text-sm font-semibold hover:underline mb-1">{{ $lowongan->nama }}</a>
