                    ...
                    <defs>
                        <clipPath id="clip0_702_17759">
                            <rect width="25.3967" height="27.7315" fill="white"
                                transform="matrix(0.985722 -0.168378 0.179073 0.983836 0.164062 4.27637)" />
                        </clipPath>
                    </defs>
                </svg>
        ...
        <div class="p-6">
            <div class="flex items-center gap-4 mb-4">
                ...
                <a href="{{ url('/admin/finance') }}"
                    class="{{ request()->is('admin/finance') ? 'bg-white text-white border-gray-500' : 'bg-white text-gray-500 border-gray-200 hover:bg-gray-200 hover:text-gray-500' }} px-8 py-2 text-md font-medium border-2 rounded-lg transition duration-200">
                    Koin</a>
                <a href="{{ url('/admin/finance/tunai') }}"
                    class="{{ request()->is('admin/finance/tunai') ? 'bg-gray-500 hover:bg-gray-600 text-white border-gray-500' : 'bg-white text-gray-500 border-gray-500 hover:bg-gray-600 hover:text-white' }} px-8 py-2 text-md font-medium border-2 rounded-lg transition duration-200">
                    Tunai</a>
                ...
                <div class="flex items-center ml-[350px] border-2 overflow-hidden rounded-lg border-gray-400">
                    ...
                    <button class="flex items-center gap-1 px-2 py-1 border-r-2 border-gray-400">
                        ...
                        <svg xmlns="http://www.w2.org/2000/svg" class="w-4 h-4 hover:bg-gray-200 text-gray-600"
                ...
                <!-- Tombol Cari -->
                <button
                    class="px-8 py-2 rounded-lg border border-gray-600 text-white bg-gray-500 hover:bg-gray-600">Cari</button>
            </div>
