...
<div style="max-width: 820px; margin: 60px auto 80px 380px; font-family: Arial, sans-serif; color: #222; position: relative;">
  ...
  <tr>
    <td valign="top" style="padding-right: 40px; text-align: center;">
      <img src="https://i.pravatar.cc/110" width="110" height="110" style="border-radius: 50%; object-fit: cover;" alt="Foto Profil" />
    </td>
...
<rect width="335" height="1" fill="#FA6601"/>
        ...
        <p style="margin: 0 0 14px 0; clear: both;">
          ...
          <b>BEM KM UGM</b><br>
          <br>sebagai anggota Divisi Humas BEM KM UGM, saya berperan dalam menjaga komunikasi yang baik antara organisasi dengan mahasiswa, pihak universitas, serta masyarakat umum. Tugas saya meliputi penyusunan strategi komunikasi, penyebaran informasi terkait kegiatan BEM melalui berbagai platform, seperti media sosial, website, dan publikasi langsung.
        </p>
      </td>
...
<rect width="335" height="1" fill="#FA6601"/>
        ...
        <p style="margin: 0 0 14px 0; clear: both;">
          <b>Jabatan – Front End Developer</b> <span style="float: right;"><b>(2022–2023)</b></span><br>
        ...
        <p style="margin: 0 0 14px 0; clear: both;">
          <b>Jabatan – Back End Developer</b> <span style="float: right;"><b>(2023–2024)</b></span><br>
