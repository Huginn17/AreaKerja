        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-2 bg-white px-3 py-2 border border-gray-500 shadow-md rounded-2xl">
                    <a href="#">
                        <img src="{{ asset('images/gambar1.jpg') }}" class="w-8 h-8 rounded-full" alt="User">
                    </a>
                    <div class="text-sm">
                ...
                <tbody class="text-center">
                    @for ($i = 0; $i < 10; $i++)
                      ...
                      <tr class="border-b-[2px] border-gray-300">
                            ...
                            <td class="px-4 py-3">
                                <a href="{{ url('/admin/detail/data/perusahaan') }}" class="hover:bg-gray-600 hover:text-white px-4 py-2 transition duration-300 rounded-xl">Seven INC</a>
                            </td>
                            <td class="px-4 py-3">seveninc@gmail.com</td>
                            <td class="px-4 py-3">(0351)-123456</td>
                            <td class="px-4 py-3">Jawa Tengah</td>
                            <td class="px-4 py-3 flex gap-2 justify-center">
                                <a href="{{ url('/admin/view/data/lowongan') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-2 py-2 rounded-md">
