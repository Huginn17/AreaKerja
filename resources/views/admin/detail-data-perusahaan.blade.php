                ...
                <div class="max-w-5xl mx-auto border-2 border-gray-400 rounded-xl shadow">
                    ...
                    <div class="max-w-4xl mx-auto bg-white p-8">
                        ...
                        <ul class="list-disc font-medium list-inside text-sm text-gray-800 mb-6">
                            <li>Menjadi perusahaan teknologi terdepan yang menciptakan solusi digital inovatif dan
                                berkelanjutan
                            </li>
                        </ul>
                        ...
                        <div class="text-sm font-medium space-y-2">
                            <div>
                                <a href="#" class="text-blue-500 text-sm font-semibold hover:underline mb-1">Front-End
                                    Developer</a>
                                <p class="text-gray-400 mb-1">Yogyakarta </p>
                                <p class="text-gray-400"> 2 hari yang lalu </p>
                            </div>
                            <div>
                                <a href="#" class="text-blue-500 text-sm font-semibold hover:underline mb-1">Back-End
                                    Developer</a>
                                <p class="text-gray-400 mb-1">Yogyakarta </p>
                                <p class="text-gray-400"> 2 hari yang lalu</p>
                            </div>
