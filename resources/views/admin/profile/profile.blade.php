                ...
                <form action="#" method="POST" class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="email" value="{{ Auth::user()->email }}" disabled
                                class="w-full border-2 border-gray-400 shadow rounded-md px-3 py-2 text-gray-500">
                    ...
                    <div class="flex">
                        <div class="mr-[25px]">
                            ...
                            <select name="provinsi" id=""
                                class="border-2 border-gray-400 rounded-md w-48 shadow px-2 py-2 text-sm text-gray-500"
                                disabled>
                        ...
                        <div class="mr-[25px]">
                            ...
                            <select name="kota" id=""
                                class="border-2 border-gray-400 rounded-md shadow w-48 py-2 px-2 text-sm text-gray-500"
                                disabled>
                        ...
                        <div>
                            ...
                            <select name="kota" id=""
                                class="border-2 border-gray-400 rounded-md shadow w-48 py-2 px-3 text-sm text-gray-500"
                                disabled>
                    ...
                    <div class="flex">
                        <div class="mr-2">
                            ...
                            <input type="text" name="desa" value="{{ Auth::user()->admin->desa }}" disabled class="w-48 border-2  border-gray-400 shadow rounded-md px-3 py-2 text-gray-500">
                        </div>
                        <div class="ml-5">
                            <label class=" block mb-1 text-sm font-medium">Kode Pos</label>
                            <input type="text" name="kode_pos" value="{{ Auth::user()->admin->kode_pos }}" disabled class="w-48 border-2 border-gray-400 shadow rounded-md px-3 py-2 text-gray-500 ">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="detail_alamat" value="{{ Auth::user()->admin->detail_alamat }}" disabled class="w-full border-2 border-gray-400 shadow rounded-md px-3 py-2 text-gray-500">
                    </div>

                    {{-- button --}}
                    <div class="flex justify-center mt-4">
                        <a href="{{ url('/admin/edit/profile') }}"
                            class="bg-gray-600 hover:bg-gray-700 text-white px-12 py-2 rounded-lg">Edit</a>
                    </div>
            </div>
