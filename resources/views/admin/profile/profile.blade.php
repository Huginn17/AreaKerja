                ...
                <form action="#" method="POST" class="space-y-4">
                    ...
                    <div class="flex">
                        <div class="mr-2">
                            ...
                            <input type="text" name="desa" value="{{ Auth::user()->admin->desa }}" disabled
                                class="w-48 border-2  border-gray-400 shadow rounded-md px-3 py-2 text-gray-500">
                        </div>
                        <div class="ml-5">
                            <label class=" block mb-1 text-sm font-medium">Kode Pos</label>
                            <input type="text" name="kode_pos" value="{{ Auth::user()->admin->kode_pos }}" disabled
                                class="w-48 border-2 border-gray-400 shadow rounded-md px-3 py-2 text-gray-500 ">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="detail_alamat" value="{{ Auth::user()->admin->detail_alamat }}"
                            disabled class="w-full border-2 border-gray-400 shadow rounded-md px-3 py-2 text-gray-500">
                    </div>
