...
<div class="max-w-4xl w-full mx-auto mt-10 border border-gray-700 rounded-lg shadow-lg p-10 bg-white text-sm font-sans translate-x-24">
 ...
 <div class="border-b border-gray-700 pb-1 mb-1 rounded-b-lg">
    <div class="flex items-center">
      <img src="{{ asset('images/seven.png') }}" alt="Logo" class="h-25">
      <h1 class="text-center text-2xl flex-grow font-bold">SEVEN INC</h1>
      <div class="w-16"></div> <!-- spacer -->
    </div>
  </div>

<div class="max-w-md ml-4 text-sm font-sans space-y-5 mt-6">
  ...
  <!-- Jenis Lowongan -->
  <div>
    <h2 class="font-semibold text-lg m-2">Culture Perusahaan</h2>
    <p class="text-red-600 text-sm font-medium">Perusahaan Belum Menyelesaikan Bagian Ini</p>
  </div>

  <!-- Deskripsi Pekerjaan -->
  <div>
    <h2 class="font-semibold text-lg m-2">Alamat Perusahaan</h2>
    <p class=" text-sm font-medium">Ngasinan, Kraguman, Jogonalan, Klaten, Jawa Tengah 57452</p>
  </div>

 <div class="space-y-2">
  <div class="font-semibold text-lg">Kriteria Kandidat</div>

  <div class="grid grid-cols-[12rem_0rem_auto] gap-x-2 items-center">
    <div class="font-medium">Posisi yang dibutuhkan</div>
    <div>:</div>
    <div>Front-End Developer</div>

    <div class="font-medium m-1">Jenis Kelamin</div>
    <div>:</div>
    <div>Laki-Laki</div>

    <div class="font-medium m-1">Kisaran Gaji</div>
    <div>:</div>
    <div>Rp 4.500.000 sampai Rp 6.500.000</div>

    <div class="font-medium m-1">Detail Tambahan</div>
    <div>: </div>
